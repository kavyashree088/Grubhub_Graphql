...
import { updateOwnerNameMutation, updateOwnerEmailMutation, updateOwnerPasswordMutation, updateOwnerRestaurantMutation } from "../../mutation/mutations";
...
class OwnerProfile extends Component {
  ...
  async componentWillMount() {
    ...
    this.props.client.query({
      ...
      this.setState({
        profile: response.data.owner,
        restaurantName: response.data.owner.restaurant.name,
        cuisine: response.data.owner.restaurant.cuisine,
        phoneNo: response.data.owner.restaurant.phoneNo,
        address: response.data.owner.restaurant.address,
        zipcode: response.data.owner.restaurant.zipcode
      })
    })
  }
  ...
  updateName = () => {
    ...
    this.props.client.mutate({
      mutation: updateOwnerNameMutation,
      variables: {
        email: localStorage.getItem("email"),
        firstName: fName,
        lastName: lName
      ...
      console.log(response);
      this.setState({
        profile: response.data.updateOwnerName
      })
    })
    this.setState({
      isNameEditable: false
  ...
  updateEmail = () => {
    if (this.validateEmail()) {
      ...
      this.props.client.mutate({
        mutation: updateOwnerEmailMutation,
        variables: {
          email: localStorage.getItem("email"),
        ...
        console.log(response);
        this.setState({
          profile: response.data.updateOwnerEmail
        })
      })
      this.setState({
        isEmailEditable: false
  ...
  updatePassword = event => {
    if (this.validatePassword()) {
      ...
      this.props.client.mutate({
        mutation: updateOwnerPasswordMutation,
        variables: {
          email: localStorage.getItem("email"),
        ...
        console.log(response);
        this.setState({
          profile: response.data.updateOwnerPassword
        })
      })
      this.setState({
        isPasswordEditable: false
  ...
  updateRestaurantDetails = () => {
    ...
    if (this.validateRestaurantDetails()) {
      this.props.client.mutate({
        mutation: updateOwnerRestaurantMutation,
        variables: {
          email: localStorage.getItem("email"),
  ...
  uploadImage = event => {
    ...
    if (this.state.imageFile !== "") {
      ...
      formData.append("id", this.state.profile.restaurant._id);
